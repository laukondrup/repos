...
program
  ...
  .option("-o, --org <name>", "Override configured org scope for this command")
...
labelCommand
  ...
  .action(async (repos, options) => {
    void repos;
    await runLabelList({ bypassOrg: options.bypassOrg, org: options.org });
  });
